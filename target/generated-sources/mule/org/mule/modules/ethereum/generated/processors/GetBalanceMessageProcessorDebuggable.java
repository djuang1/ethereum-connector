...
public class GetBalanceMessageProcessorDebuggable
    extends GetBalanceMessageProcessor
    implements DebugInfoProvider
{


    public GetBalanceMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("address", "Address", (java.lang.String.class), address, muleEvent));
