...
/**
 * TransactionFilterMessageSource wraps {@link org.mule.modules.ethereum.EthereumConnector#transactionFilter(org.mule.api.callback.SourceCallback)} method in {@link EthereumConnector } as a message source capable of generating Mule events.  The POJO's method is invoked in its own thread.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2018-03-22T09:33:44-05:00", comments = "Build UNNAMED.2793.f49b6c7")
public class TransactionFilterMessageSource
    ...
    implements Runnable, FlowConstructAware, MuleContextAware, Startable, Stoppable, MessageSource
{
    ...
    public TransactionFilterMessageSource(String operationName) {
        super(operationName);
    }
            ...
            while (!Thread.currentThread().isInterrupted()) {
                processTemplate.execute(new ProcessCallback<Object,Object>() {
                    ...
                    public Object process(Object object)
                        throws Exception
                    {
                        ((EthereumConnector) object).transactionFilter(sourceCallback);
                        return null;
                    }
