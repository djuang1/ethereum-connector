...
/**
 * A <code>EthereumConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link EthereumConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2018-03-22T09:33:44-05:00", comments = "Build UNNAMED.2793.f49b6c7")
public class EthereumConnectorLifecycleInjectionAdapter
    extends EthereumConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(EthereumConnectorLifecycleInjectionAdapter.class);
